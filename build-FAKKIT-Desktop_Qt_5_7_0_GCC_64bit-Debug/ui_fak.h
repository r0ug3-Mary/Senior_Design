...
""));
        ...
        InventoryButton->setStyleSheet(QStringLiteral("background-image: url(:/pics/fridge1.jpeg);"));
        ...
        RecipeButton->setStyleSheet(QStringLiteral("background-image: url(:/pics/fridge2.jpeg);"));
        ...
        ShoppingButton->setStyleSheet(QStringLiteral("background-image: url(:/pics/fridge3.jpeg);"));
        ...
        pushButton->setStyleSheet(QStringLiteral("background-image: url(:/pics/fridge4.jpeg);"));
    ...
    void retranslateUi(QMainWindow *FAK)
    {
        ...
        pushButton->setText(QApplication::translate("FAK", "Fridge View", 0));
    } // retranslateUi
