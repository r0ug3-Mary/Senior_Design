...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ViewPage_t, stringdata) + ofs \
...
const QMetaObject ViewPage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ViewPage.data,
      qt_meta_data_ViewPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ViewPage.stringdata))
