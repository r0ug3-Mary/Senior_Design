    ...
    ui(new Ui::RecentPage)
{
    ...
    ui->tableView->horizontalHeader()->setDefaultSectionSize(75);
    ...
    for (int i=0; i < rowcount; i++)
    {
        ...
        button->setStyleSheet("QPushButton{background-image: url(:/pics/highbutton.png);");
    ...
    for (int i=0; i < rowcount; i++)
    {
        ...
        button2->setStyleSheet("QPushButton{background-image: url(:/pics/lowbutton.png) 0 0 0 0 stretch stretch; background-position: center; background-repeat: repeat-false;");
    ...
    for (int i=0; i < rowcount; i++)
    {
        ...
        button3->setStyleSheet("QPushButton{background-image: url(:/pics/emptybutton.png) 0 0 0 0 stretch stretch; background-position: center; background-repeat: repeat-false;");
